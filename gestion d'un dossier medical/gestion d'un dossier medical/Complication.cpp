...
#include<iostream>
Complication::Complication(int id, string type, string gravite) :idComplication(id), type(type), gravite(gravite){}
...
{
	cout << "Id de la complication : " << idComplication << endl;
...
ostream& operator<<(ostream& out, Complication& c) {
		...
		out << "Id Complication : " << c.idComplication << ",Type Complication : " << c.type << ",Gravite : " << c.gravite;
		return out;
}
